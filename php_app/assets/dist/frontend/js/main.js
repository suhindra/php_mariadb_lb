  ...
  $(document).ready(function() {  
    function initialize() {
      var mapOptions = {
        ...
        draggable: false,
        scrollwheel: false,
        center: new google.maps.LatLng(-7.5572587,110.8564557)
      },
      map = new google.maps.Map(document.getElementById('map-canvas-lg'), mapOptions);

      var image = 'assets/images/marker.png';
      var myLatLng = new google.maps.LatLng(-7.55611,110.861348);
      var beachMarker = new google.maps.Marker({
          position: myLatLng,
          map: map,
          icon: image,
          title: 'Kentingan Outdoor'
      });
    }
  ...
  $(document).ready(function() {  
    function initialize() {
      var mapOptions = {
        ...
        draggable: false,
        scrollwheel: false,
        center: new google.maps.LatLng(-7.55611,110.861348)
      },
